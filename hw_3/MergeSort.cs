// Dafny program MergeSort.dfy compiled into C#
...
public class @__default {
  public void @MergeSort(BigInteger[] @a1, out BigInteger[] @a)
  {
    @a = (BigInteger[])null;
  TAIL_CALL_START: ;
    var _this = this;
    BigInteger[] _out0;
    (_this).@ms(@a1, new BigInteger(0), (new BigInteger((@a1).@Length)) - (new BigInteger(1)), out _out0);
    @a = _out0;
    return;
  }
  public void @ms(BigInteger[] @a1, BigInteger @l, BigInteger @u, out BigInteger[] @a)
  {
    @a = (BigInteger[])null;
    @a = Dafny.Helpers.InitNewArray1<BigInteger>((new BigInteger((@a1).@Length)));
/* Compilation error: an assume statement cannot be compiled (line 21) */
    ...
    {
      BigInteger @_0_m = BigInteger.Zero;
      @_0_m = Dafny.Helpers.EuclideanDivision(((@l) + (@u)), new BigInteger(2));
      BigInteger[] _out1;
      (this).@ms(@a, @l, @_0_m, out _out1);
      @a = _out1;
      BigInteger[] _out2;
      (this).@ms(@a, (@_0_m) + (new BigInteger(1)), @u, out _out2);
      @a = _out2;
      BigInteger[] _out3;
      (this).@merge(@a, @l, @_0_m, @u, out _out3);
      @a = _out3;
      return;
    }
  }
  public void @merge(BigInteger[] @a1, BigInteger @l, BigInteger @m, BigInteger @u, out BigInteger[] @a)
  {
    @a = (BigInteger[])null;
  TAIL_CALL_START: ;
    var _this = this;
    @a = Dafny.Helpers.InitNewArray1<BigInteger>((new BigInteger((@a1).@Length)));
/* Compilation error: an assume statement cannot be compiled (line 43) */
    { }
    BigInteger[] @_1_buf = (BigInteger[])null;
    @_1_buf = Dafny.Helpers.InitNewArray1<BigInteger>((((@u) - (@l)) + (new BigInteger(1))));
    BigInteger @_2_i = BigInteger.Zero;
    @_2_i = @l;
    BigInteger @_3_j = BigInteger.Zero;
    @_3_j = (@m) + (new BigInteger(1));
    BigInteger @_4_k = BigInteger.Zero;
    @_4_k = new BigInteger(0);
    while ((@_4_k) < (((@u) - (@l)) + (new BigInteger(1))))
    {
      if ((@_2_i) > (@m))
      {
        (@_1_buf)[(int)(@_4_k)] = (@a)[(int)(@_3_j)];
        @_3_j = (@_3_j) + (new BigInteger(1));
      }
      else
      if ((@_3_j) > (@u))
      {
        (@_1_buf)[(int)(@_4_k)] = (@a)[(int)(@_2_i)];
        @_2_i = (@_2_i) + (new BigInteger(1));
      }
      else
      if (((@a)[(int)(@_2_i)]) <= ((@a)[(int)(@_3_j)]))
      {
        (@_1_buf)[(int)(@_4_k)] = (@a)[(int)(@_2_i)];
        @_2_i = (@_2_i) + (new BigInteger(1));
      }
      ...
      @_4_k = (@_4_k) + (new BigInteger(1));
    }
/* Compilation error: an assume statement cannot be compiled (line 79) */
    { }
/* Compilation error: an assume statement cannot be compiled (line 80) */
    { }
    @_4_k = new BigInteger(0);
    while ((@_4_k) < (((@u) - (@l)) + (new BigInteger(1))))
    {
      (@a)[(int)((@l) + (@_4_k))] = (@_1_buf)[(int)(@_4_k)];
      @_4_k = (@_4_k) + (new BigInteger(1));
    }
  }
}
